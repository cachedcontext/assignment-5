        ...
        <div className="bg-white border border-slate-100 shadow-sm rounded-2xl p-5">
            ...
            {stack.length ===0 ? (
                ...
                <div className="mt-4 space-y-3">
                    {stack.map((item) => (
                        <div key={item.id} className="flex justify-between items-center bg-slate-50 border border-slate-100 rounded-xl p-3">
                    ...
                    <button onClick={removeAll} className="text-sm font-medium w-full border border-red-200 text-red-500 rounded-lg hover:bg-red-50 mt-2 py-2 transition">
                        Remove All
                    </button>
                </div>
            )}
